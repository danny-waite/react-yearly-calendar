...
var Month = function (_Component) {
  ...
  _createClass(Month, [{
    ...
    key: 'UNSAFE_shouldComponentUpdate',
    value: function UNSAFE_shouldComponentUpdate(nextProps) {
    ...
    value: function renderMonthDays() {
      ...
      (0, _utils.range)(firstDayOfWeek + 1, totalDays + firstDayOfWeek + 1).forEach(function (i) {
        ...
        var dayData = data.find(function (d) {
          return (0, _moment2.default)(d.date).isSame(day);
        });
        if (dayData) {
          if (dayData.bookable) classes.push('day-bookable');else classes.push('day-not-bookable');
        }
